                ...
                {steps.map((label, i) => {
                    ...
                    return (
                        <div key={i} className="flex items-center">
                            ...
                            {/* Label */}
                            <span
                                className={`ml-1 text-[11px] font-body whitespace-nowrap ${isActive ? 'text-saffron font-medium' : isCompleted ? 'text-navy' : 'text-gray-400'
                                    }`}
                            >
                                {label}
                            </span>
                            ...
                            {i < total - 1 && (
                                <div
                                    className={`w-5 h-0.5 mx-1 transition-colors duration-300 ${isCompleted ? 'bg-saffron' : 'bg-gray-200'
                                        }`}
                                />
                            )}
                        </div>
